...
public class GruposPesquisar extends Janela {

    private final String Acao;
    private final Grupos despesas_categoria;

    public GruposPesquisar(Grupos despesasCategoria, String acao) {
        initComponents();
    ...
    public void Filtrar()
    {
        try
        {
            Banco.executeQuery("SELECT * FROM relatorios_grupos WHERE nome LIKE '%"+nome.getText()+"%' ORDER BY nome ASC");
            ...
            while(Banco.getResultSet().next())
            {
                ...
                modelo.addRow(new Object[]{Banco.getResultSet().getString("id_relatorios_grupos"),Banco.getResultSet().getString("nome"),Banco.getResultSet().getString("valor"),saldototal});
            }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, Lingua.getMensagem("grupo"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, FonteFinancas, new java.awt.Color(0, 102, 204)));
        ...
        if (resultado_pesquisa.getColumnModel().getColumnCount() > 0) {
            ...
            resultado_pesquisa.getColumnModel().getColumn(2).setHeaderValue(Lingua.getMensagem("valor"));
            resultado_pesquisa.getColumnModel().getColumn(3).setHeaderValue(Lingua.getMensagem("ativado"));
        }
...
private void resultado_pesquisaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_resultado_pesquisaMouseClicked
    ...
    if(Janelinha.Pergunta(codSelecionado1, Lingua.getMensagem("tem_certeza"))){
        despesas_categoria.PreencherFormulario(Acao,codSelecionado0,codSelecionado1,codSelecionado2,codSelecionado3);
        GruposPesquisar.this.dispose();
    }
