...
public class TransferenciasCategoriaPesquisar extends Janela {

    private final String Acao;
    private final TransferenciasCategoria transferencias_categoria;
    
    public TransferenciasCategoriaPesquisar(TransferenciasCategoria transferenciasCategoria, String acao) {
        initComponents();
        Visual.Janela(this.getJanela());
        BarraDeFerramentas.add(Botoes.Sair(this));
        Acao = acao;
        transferencias_categoria = transferenciasCategoria;
    ...
    public void Filtrar()
    {
        try
        {
            Banco.executeQuery("SELECT * FROM transferencias_categorias WHERE nome LIKE '%"+nome.getText()+"%' ORDER BY nome ASC");
    ...
    public void Botoes(String acao)
    {
        if(acao.equals(Lingua.getMensagem("sair"))){
            TransferenciasCategoriaPesquisar.this.dispose();
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, Lingua.getMensagem("transferencias")+" > "+Lingua.getMensagem("categoria"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, FonteFinancas, new java.awt.Color(0, 102, 204)));
...
private void resultado_pesquisaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_resultado_pesquisaMouseClicked
    ...
    if(Janelinha.Pergunta(codSelecionado1, Lingua.getMensagem("tem_certeza"))){
        transferencias_categoria.PreencherFormulario(Acao,codSelecionado0,codSelecionado1);
        TransferenciasCategoriaPesquisar.this.dispose();
    }
