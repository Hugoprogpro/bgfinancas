...
public final class DespesasItemPesquisar extends Janela {

    private final String Acao;
    private final DespesasItem despesas_item;

    public DespesasItemPesquisar(DespesasItem despesaItem, String acao) {
        initComponents();
        Visual.Janela(this.getJanela());
        BarraDeFerramentas.add(Botoes.Sair(this));
        Acao = acao;
        despesas_item = despesaItem;
        PreencherCategorias();
    ...
    public void Filtrar()
    {
        ...
        {
            Banco.executeQuery("SELECT despesas_itens.*, despesas_categorias.nome AS categoria_nome FROM despesas_itens, despesas_categorias WHERE despesas_itens.nome LIKE '%"+nome.getText()+"%' AND despesas_itens.id_categoria = despesas_categorias.id_categoria ORDER BY despesas_categorias.nome ASC, despesas_itens.nome ASC");
        }else{
            ...
            Banco.executeQuery("SELECT despesas_itens.*, despesas_categorias.nome AS categoria_nome FROM despesas_itens, despesas_categorias WHERE despesas_itens.nome LIKE '%"+nome.getText()+"%' AND despesas_itens.id_categoria='"+ID_CATEGORIA+"' AND despesas_itens.id_categoria = despesas_categorias.id_categoria ORDER BY nome ASC");
        }
        try
        {
    ...
    public void Botoes(String acao)
    {
        if(acao.equals(Lingua.getMensagem("sair"))){
            DespesasItemPesquisar.this.dispose();
        }
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(695, 480));
...
private void resultado_pesquisaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_resultado_pesquisaMouseClicked
    ...
    if(Janelinha.Pergunta(codSelecionado1, Lingua.getMensagem("tem_certeza"))){
        despesas_item.PreencherFormulario(Acao,codSelecionado0,codSelecionado1,codSelecionado2);
        DespesasItemPesquisar.this.dispose();
    }
