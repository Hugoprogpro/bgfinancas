...
public final class TransferenciasItemPesquisar extends Janela {

    private final String Acao;
    private final TransferenciasItem transferencias_item;
    
    public TransferenciasItemPesquisar(TransferenciasItem despesaItem, String acao) {
        initComponents();
        Visual.Janela(this.getJanela());
        BarraDeFerramentas.add(Botoes.Sair(this));
        Acao = acao;
        transferencias_item = despesaItem;
        PreencherCategorias();
    ...
    public void Botoes(String acao)
    {
        if(acao.equals(Lingua.getMensagem("sair"))){
            TransferenciasItemPesquisar.this.dispose();
        }
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(706, 480));
...
private void resultado_pesquisaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_resultado_pesquisaMouseClicked
    ...
    if(Janelinha.Pergunta(codSelecionado1, Lingua.getMensagem("tem_certeza"))){
        transferencias_item.PreencherFormulario(Acao,codSelecionado0,codSelecionado1,codSelecionado2);
        TransferenciasItemPesquisar.this.dispose();
    }
