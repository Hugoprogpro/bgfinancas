...
public class DespesasCategoriaPesquisar extends Janela {

    private final String Acao;
    private final DespesasCategoria despesas_categoria;
    
    public DespesasCategoriaPesquisar(DespesasCategoria despesasCategoria, String acao) {
        initComponents();
    ...
    public void Filtrar()
    {
        try
        {
            Banco.executeQuery("SELECT * FROM despesas_categorias WHERE nome LIKE '%"+nome.getText()+"%' ORDER BY nome ASC");
    ...
    public void Botoes(String acao)
    {
        if(acao.equals(Lingua.getMensagem("sair"))){
            DespesasCategoriaPesquisar.this.dispose();
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, Lingua.getMensagem("despesas")+" > "+Lingua.getMensagem("categoria"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, FonteFinancas, new java.awt.Color(0, 102, 204)));
...
private void resultado_pesquisaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_resultado_pesquisaMouseClicked
    ...
    if(Janelinha.Pergunta(codSelecionado1, Lingua.getMensagem("tem_certeza"))){
        despesas_categoria.PreencherFormulario(Acao,codSelecionado0,codSelecionado1);
        DespesasCategoriaPesquisar.this.dispose();
    }
