...
public final class TransferenciasItensPesquisar extends Janela {

    private final Transferencias Transferencias;

    public TransferenciasItensPesquisar(Transferencias transferencias) {
        initComponents();
    ...
    public void Filtrar()
    {
        ...
        {
            Banco.executeQuery("SELECT transferencias_itens.*, transferencias_categorias.nome AS categoria_nome FROM transferencias_itens, transferencias_categorias WHERE transferencias_itens.nome LIKE '%"+nome.getText()+"%' AND transferencias_itens.id_categoria = transferencias_categorias.id_categoria ORDER BY nome ASC");
        }else{
            ...
            Banco.executeQuery("SELECT transferencias_itens.*, transferencias_categorias.nome AS categoria_nome FROM transferencias_itens, transferencias_categorias WHERE transferencias_itens.nome LIKE '%"+nome.getText()+"%' AND transferencias_itens.id_categoria='"+ID_CATEGORIA+"' AND transferencias_itens.id_categoria = transferencias_categorias.id_categoria ORDER BY nome ASC");
        }
        try
        {
    ...
    public void Botoes(String acao)
    {
        if(acao.equals(Lingua.getMensagem("sair"))){
            TransferenciasItensPesquisar.this.dispose();
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, Lingua.getMensagem("transferencias")+" > "+Lingua.getMensagem("item"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, FonteFinancas, new java.awt.Color(0, 102, 204)));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(BarraDeFerramentas, javax.swing.GroupLayout.DEFAULT_SIZE, 639, Short.MAX_VALUE)
        ...
        setSize(new java.awt.Dimension(655, 480));
...
private void resultado_pesquisaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_resultado_pesquisaMouseClicked
    ...
    if(Janelinha.Pergunta(codSelecionado1, Lingua.getMensagem("tem_certeza"))){
        Transferencias.AdicionarItem(codSelecionado1);
        TransferenciasItensPesquisar.this.dispose();
    }
